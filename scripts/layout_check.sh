...
# a new pass.
#
# Twenty of the 126 pass, and what is left is measured rather than guessed. The failures are grouped by
...
#
#   Last derived at 20 of 126: anonymous boxes and out-of-flow floats are in. What remains is where a
#   float SHORTENS a line beside it, floats placed side by side, and:
