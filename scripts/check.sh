...
out=$("$MERE" "$ROOT/test/dom_check.mere"; "$MERE" "$ROOT/test/tree_check.mere"; "$MERE" "$ROOT/test/sniff_check.mere"; "$MERE" "$ROOT/test/nodes_check.mere"; "$MERE" "$ROOT/test/formatting_check.mere")
echo "$out"
