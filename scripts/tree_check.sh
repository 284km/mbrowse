...
# What the 63 failures are, grouped by the first line of the tree that differs rather than
...
# select insertion mode, frameset, the table row and column implied closes, the adoption
